...
import 'package:Schools/Screens/TeacherScreens/attendance1.dart';
...
class FiltersScreen extends StatefulWidget {
  ...
  FiltersScreen({this.oldUsers});

  @override
  _FiltersScreenState createState() => _FiltersScreenState(oldUsers: oldUsers);
}
...
class _FiltersScreenState extends State<FiltersScreen> {
  ...
  _FiltersScreenState({this.oldUsers});
  @override
  void initState() {
    super.initState();
    classes = Map();
    ...
    oldUsers.forEach((element) {
      if (element.classNumber != '') {
        classes[element.classNumber] = false;
      }
      if (element.section != '') {
        section[element.section] = false;
      }
      if (element.runtimeType == Student) {
...
/*--------------------------------Main Body-----------------------------------*/
      ...
      floatingActionButton: count > 0 || isRollNoSelected
  ...
  void done() {
    ...
    Navigator.pop(context, newUsers);
  }
