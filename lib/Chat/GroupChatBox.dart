    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: <Widget>[
            icon != null
                ? CircleAvatar(backgroundColor: Colors.white, backgroundImage: NetworkImage(icon, scale: 0.2))
                : CircleAvatar(
                    child: Icon(
                      Icons.people,
